                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('edit_client') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="national_id" type="number"  pattern ="{14,}"   class="form-control @error('national_id') is-invalid @enderror" name="national_id" value="{{$client->national_id }}" required >
